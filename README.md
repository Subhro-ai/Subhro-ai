...
**4 merged pull requests** across **1 repository**.

| Repository | Pull request | Merged | Diff |
| --- | --- | --- | --- |
| [microsoft/PowerToys](https://github.com/microsoft/PowerToys) | [#50054 — \[CmdPal\] Window Walker: match app name and window title together](https://github.com/microsoft/PowerToys/pull/50054) | Sep 2026 | `+254 −7` |
| [microsoft/PowerToys](https://github.com/microsoft/PowerToys) | [#50693 — \[CmdPal\] Window Walker: show owned windows marked WS_EX_APPWINDOW](https://github.com/microsoft/PowerToys/pull/50693) | Sep 2026 | `+10 −4` |
| [microsoft/PowerToys](https://github.com/microsoft/PowerToys) | [#49437 — \[CmdPal\] Add "Update and restart" / "Update and shut down" system com…](https://github.com/microsoft/PowerToys/pull/49437) | Aug 2026 | `+579 −19` |
| [microsoft/PowerToys](https://github.com/microsoft/PowerToys) | [#49356 — \[CmdPal Calculator\] Add reciprocal/inverse trig functions and n-th log/root; fix inverse function parse errors](https://github.com/microsoft/PowerToys/pull/49356) | Jul 2026 | `+213 −1` |
